...
export function EditModal({ car }) {
  const { _id, imageUrl, carName, capacity, pickup,description, rentPrice, availabil } = car;
              ...
              <Surface variant="default">
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        {/* Daily Rent Price */}
                        <TextField defaultValue={rentPrice} name="rentPrice" isRequired>
                        ...
                        {/* Pickup Location */}
                        <TextField defaultValue={pickup} name="pickup" isRequired>
                        ...
                        <div className="md:col-span-2">
                         ...
                         {/* Availability Status */}
                        <TextField defaultValue={availabil} name="availabil" isRequired>
